...
namespace BitBot
{
    internal static class TradingEngine
    {
        ...
        static internal bool loadAccounts()
        {
            ...
            byte[] secretDecoded = Convert.FromBase64String(Properties.Settings.Default.tbAPISecret);
            ...
            accountsRequest.Headers.Add("CB-ACCESS-KEY", Properties.Settings.Default.tbAPIID);
            ...
            accountsRequest.Headers.Add("CB-ACCESS-PASSPHRASE", Properties.Settings.Default.tbAPIPassphrase);
        ...
        static internal CoinbaseOrderPostResponse PostOrder(decimal size, decimal price, bool isBuyOrder)
        {
            ...
            postRequest.Headers.Add("CB-ACCESS-KEY", Properties.Settings.Default.tbAPIID);
            ...
            postRequest.Headers.Add("CB-ACCESS-PASSPHRASE", Properties.Settings.Default.tbAPIPassphrase);
