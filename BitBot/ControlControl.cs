...
namespace BitBot
{
    internal partial class ControlControl : UserControl
    {
        ...
        private void btnTestMessage_Click(object sender, EventArgs e)
        {
            ...
            testRequest.Headers.Add("CB-ACCESS-KEY", Properties.Settings.Default.tbAPIID);
            ...
            testRequest.Headers.Add("CB-ACCESS-PASSPHRASE", Properties.Settings.Default.tbAPIPassphrase);
